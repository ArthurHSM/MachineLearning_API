...
DB_URL = "sqlite:///predictions.db"  # URL do banco de dados SQLite
...
def token_required(f):
    ...
    def decorated(*args, **kwargs):
        # pegar token do header Authorization: Beares <token>
...
def predict():
    ...
    try:
        ...
        return jsonify({"erro": "Dados inválidos, verifique parâmetros"}), 400
